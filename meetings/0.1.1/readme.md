...
#import "@rookery/meetings:0.1.1": meeting
...
- `occurred`, a log stage (`OCCURRED-STAGE`) that `on:` writes into
  [`@rookery/timeline`](../../timeline/0.1.1)'s per-note log.
...
```typst
#import "@rookery/core:0.1.1": tag-data
#import "@rookery/meetings:0.1.1": meeting-with-of, occurred-of
...
```typst
#import "@rookery/meetings:0.1.1": meetings
...
- [`@rookery/core:0.1.1`](../../core/0.1.0) and
  [`@rookery/timeline:0.1.1`](../../timeline/0.1.1), both imported as aliased
