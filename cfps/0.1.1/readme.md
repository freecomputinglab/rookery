...
#import "@rookery/cfps:0.1.1": cfps
#show: rookery
...
[`@rookery/timeline`'s own `ladder.typ`](../../timeline/0.1.1/src/ladder.typ)
...
`#cfp` is built on [`@rookery/todos`](../../todos/0.1.1)' own `todo(..)`, not
...
- [`@rookery/core:0.1.1`](../../core/0.1.0),
  [`@rookery/timeline:0.1.1`](../../timeline/0.1.1) and
  [`@rookery/todos:0.1.1`](../../todos/0.1.1). All three are hard imports —
