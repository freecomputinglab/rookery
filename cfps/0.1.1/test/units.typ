...
#import "/src/lib.typ": *
#import "@rookery/core:0.1.1": rookery, tag-data, idea-tag-names
#import "@rookery/timeline:0.1.1": CLOSED-STAGE, timeline-tags, has-stage
...
#context {
  assert.eq(idea-tag-names("units-venue-auto"), ("venue",))
}
