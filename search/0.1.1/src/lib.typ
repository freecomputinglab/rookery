...
// its internals: `ideas()` for the notes, `idea-href()` for links. Nothing here
...
#import "@rookery/core:0.1.1": ideas, idea-href
...
// `@rookery/search:0.1.1` is a single import for a project, and `.marrow.typ`
