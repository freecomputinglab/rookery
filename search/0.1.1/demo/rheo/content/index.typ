#import "lib.typ": demo
#import "@rookery/core:0.1.1": footnote, idea, ideas-outline, window
...
#import "@rookery/search:0.1.1": filter-panel, panel, search-bar, search-ideas, search-index, search-modal
