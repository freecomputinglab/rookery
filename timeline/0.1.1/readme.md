...
#import "@rookery/timeline:0.1.1": timeline-tags
...
| was | is |
| --- | --- |
| `@rookery/core-dates` 0.5.0 and 0.6.0 | `@rookery/timeline:0.1.1` |
...
```typst
#import "@rookery/timeline:0.1.1": idea, rookery, window
#show: rookery
...
pill, but it is still presence-filterable by key — `#window(tagged: "timeline-log")`
...
```typst
#import "@rookery/core:0.1.1": idea
#import "@rookery/timeline:0.1.1": dated
...
```typst
#import "@rookery/core:0.1.1": tag-index
#import "@rookery/timeline:0.1.1": (
...
```typst
#import "@rookery/timeline:0.1.1": timeline-view
...
```typst
#import "@rookery/timeline:0.1.1": upcoming, DEADLINE-STAGE, SCHEDULED-STAGE
...
| | |
|---|---|
| `tags:` / `match:` | rookery's own selection vocabulary — `ideas()`'s `tagged:`/`match:`, passed straight through |
