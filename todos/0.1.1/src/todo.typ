...
#import "@rookery/core:0.1.1": idea, _merge-base-tags, _norm
#import "@rookery/timeline:0.1.1": CLOSED-STAGE, dated
#import "tags.typ": *
...
// consume: `title`, `level`, `created`, `display-date`, `display-tags`.
//
