...
// hyperlink` and #idea-tag-names/#ideas-outline all reading the SAME non-default
...
#import "../../src/lib.typ": idea, window, hyperlink, idea-tag-names, ideas-outline
...
#context [Et al.'s tags: #repr(idea-tag-names("etal"))]

#ideas-outline(title: [Everything under "note:"])
